  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="NseOI: Transforming raw data from nseindia.com into the latest, ready-to-use pandas Dataframes in Python, for seamless, efficient and real-time data analysis."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1551288049-bebda4e38f71?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxkYXRhJTIwYW5hbHlzaXN8ZW58MHx8fHwxNjk1NzU3NDU4fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@lukechesser?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Luke Chesser`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`NseOI: Transforming raw data from nseindia.com into the latest, ready-to-use pandas Dataframes in Python, for seamless, efficient and real-time data analysis.`}
            </Text>
            <Box
