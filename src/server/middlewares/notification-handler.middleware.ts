...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'order.create': { roles: ['owner', 'administrator'], key: 'order_id', tenantPath: [], userPath: [] },
  'pricing.update': { roles: ['owner', 'administrator'], key: 'pricing_id', tenantPath: [], userPath: [] },
  'product.create': { roles: ['owner', 'administrator'], key: 'product_id', tenantPath: [], userPath: [] },
};
